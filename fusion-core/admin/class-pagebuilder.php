...
if( ! class_exists( 'Fusion_Core_PageBuilder' ) ) {
	...
	class Fusion_Core_PageBuilder {
		...
		public function admin_notices() {
			...
			?>
			<div class="error fusion-builder-settings-error" style="display: none;">
				<p><?php echo __( "We're sorry but fusion builder has timed out, and it is most likely due to low PHP configurations on your server. Please fix the problems below:", 'Avada' ); ?></p>
				<ol>
					<?php
				...
				<p>
					<a href="<?php echo admin_url( 'admin.php?page=avada-system-status' ); ?>" class="button-primary"><?php _e( 'System Status', 'Avada' ); ?></a>
					<a href="<?php echo $full_link; ?>&amp;fb_system_req_nag=0" class="button-secondary"><?php _e( 'Dismiss Notice', 'Avada' ); ?></a>
				</p>
			</div>
		<?php
			endif;
